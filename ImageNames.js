...
var uniqueList = {
  ...
  "Fathomless Mud of the Swamp" : ["exaltation_of_tangled_growth", "foul_vapors_and_fetid_muck", "intractable_thickets_and_thorns", "open_shifting_waterways"],
  "Devouring Teeth Lurk Underfoot" : ['ferocious_rampage', 'gift_of_furious_might', 'herd_towards_the_lurking_maw', 'mark_territory_with_scars_and_teeth'],
  "Eyes Watch From The Trees" : ['boon_of_watchful_guarding', 'eerie_noises_and_moving_trees','mysterious_abductions','whispered_guidance_through_the_night'],
  "Rising Heat of Stone and Sand" : ['call_on_herders_for_aid', 'gift_of_searing_heat', 'stinging_sandstorm', 'sweltering_exhaustion'],
  "Sun-Bright Whirlwind": ['gift_of_the_sunlit_air', 'gift_of_windsped_steps', 'scatter_to_the_winds', 'tempest_of_leaves_and_branches']
}

var unique = ["harbingers_of_the_lightning", "boon_of_vigor", "rivers_bounty", "concealing_shadows", "voice_of_thunder", "call_of_the_deeps", "swallow_the_landdwellers", "call_on_midnights_dreams", "dreams_of_the_dahan", "fields_choked_with_growth", "stem_the_flow_of_fresh_water", "too_near_the_jungle", "flames_fury", "threatening_flames", "lightnings_boon", "wash_away", "favors_called_due", "mantle_of_dread", "crops_wither_and_fade", "draw_of_the_fruitful_earth", "words_of_warning", "grasping_tide", "tidal_boon", "gift_of_proliferation", "prey_on_the_builders", "teeth_gleam_from_darkness", "terrifying_chase", "regrow_from_roots", "boon_of_growing_power", "gift_of_the_primordial_deeps", "gift_of_flowing_power", "elemental_aegis", "shatter_homesteads", "flash_floods", "sudden_ambush", "predatory_nightmares", "dread_apparitions", "overgrow_in_a_night", "sacrosanct_wilderness", "flashfires", "asphyxiating_smoke", "absorb_essence", "raging_storm", "guard_the_healing_land", "a_year_of_perfect_stillness", "rituals_of_destruction", "manifestation_of_power_and_glory", "towering_wrath", "exaltation_of_tangled_growth", "foul_vapors_and_fetid_muck", "intractable_thickets_and_thorns", "open_shifting_waterways", 'ferocious_rampage', 'gift_of_furious_might', 'herd_towards_the_lurking_maw', 'mark_territory_with_scars_and_teeth', 'boon_of_watchful_guarding', 'eerie_noises_and_moving_trees','mysterious_abductions','whispered_guidance_through_the_night', 'call_on_herders_for_aid', 'gift_of_searing_heat', 'stinging_sandstorm', 'sweltering_exhaustion', 'gift_of_the_sunlit_air', 'gift_of_windsped_steps', 'scatter_to_the_winds', 'tempest_of_leaves_and_branches'];
